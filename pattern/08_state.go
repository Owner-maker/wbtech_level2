...
2) Наличие switch или большой условной конструкции, а также дублирующих кусков кода с похожими состояними объекта

Плюсы:
1) Избавление от больших условных конструкций (или свитчей)
2) Весь код, отсносящийся к одному состоянию объекта находится в одном месте -> упрощение читабельности кода

Минусы:
1) Оверкилл для сликшом маленького кол-ва состояний

Примеры:
1) Состояние Документа при его модификации:в состоянии черновика, под редакцией илиуже опубликован. В каждом из этих состояний должны
